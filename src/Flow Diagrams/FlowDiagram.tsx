	...
	return (
		<>
			<div style={{ width, height }}>
				<ReactFlow style={styles} nodes={nodes} edges={edges} nodeTypes={nodeTypes} onNodesChange={onNodesChange} onEdgesChange={onEdgesChange} edgeTypes={edgeTypes} onConnect={onConnect} colorMode="dark" snapToGrid zoomOnScroll={!disableZoomPan} zoomOnPinch={!disableZoomPan} panOnScroll={!disableZoomPan} panOnDrag={!disableZoomPan} preventScrolling={!disableZoomPan} {...(fitView ? { fitView, fitViewOptions: FitViewOptions } : { defaultViewport: initialViewport })}>
					{miniMap && <MiniMap />}
					{controls && <Controls />}
					{editMode && <Background />}
				</ReactFlow>
