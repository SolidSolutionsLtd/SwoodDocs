	...
	return (
		<>
			...
			<ul>
				...
				<li>
					<a href="#EvaluateFormat">How Define the Evaluated Property Format</a>
				</li>
				<li>
			...
			<Section id="EvaluateFormat" title="How define the evaluated Property Format">
				<Typography>
					To specify the format for evaluated properties, include the number format as shown here: <span className="highlight">«EVAL("PropertiesToEvaluate")0:000»</span>. For example, <span className="highlight">Panel Area: «EVAL(«Length»*«Width»)0:000»</span>. For a panel measuring 1000x500, the table will display <span className="highlight">Panel Area: 500000.000</span>.
				</Typography>
			</Section>
