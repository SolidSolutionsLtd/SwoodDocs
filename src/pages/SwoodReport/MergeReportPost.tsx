...
import DownloadMergeReportPost from '../../components/DownloadMergeReportPost'
import { MergeReportPostTag, SolidWorksTag, SwoodDataDirectoryTag, SwoodDesignTag, SwoodNestingTag } from '../../components/NameTags'
import MergeReportDiagram from '../../Flow Diagrams/MergeReportDiagram'

const MergeReportPost = () => {
	return (
		<>
			...
			<nav>
				<ul>
					...
					<li>
						<a href="#Disclaimer">MergeReportPost disclaimer</a>
					</li>
					<li>
						<a href="#Setup">How to set up MergeReportPost</a>
					</li>
				</ul>
			</nav>
			<Section id="Overview" title="Overview">
				...
				<Typography>
					To address this, a new <MergeReportPostTag /> has been developed to consolidate the data from Design and Nesting projects into a single report. Please read further to understand its workflow, FAQs, and setup.
				</Typography>
			...
			<Section id="Terminology" title="Terminology">
				...
				<ListItem>
					<ListItemText
						...
						secondary={
							<>
								A report generated by <MergeReportPostTag />
							</>
						}
					/>
				</ListItem>
			...
			<Section id="Workflow" title="Workflow">
				...
				<ol>
					...
					<li>
						<MergeReportPostTag /> will automatically generate a merged report.
					</li>
				</ol>
				<MergeReportDiagram />
			</Section>
			<Section id="FAQs" title="FAQs">
				...
				<ListItem>
					<ListItemText
						...
						secondary={
							<>
								<MergeReportPostTag /> will only merge the available data from existing reports. As a result, some information such as hardware, frames, and unnested panels may be missing in the merged report.
							</>
						}
					/>
				</ListItem>
				...
				<ListItem>
					<ListItemText
						...
						secondary={
							<>
								<MergeReportPostTag /> will not generate any files. You will also notice the message below when clicking on <span className="param">Documents &gt; Home Merged Report</span>.
							</>
						}
					/>
				</ListItem>
			...
			<Box className="red">
				<Section id="Disclaimer" title="MergeReportPost disclaimer">
					<BetaDisclaimer />
				</Section>
			</Box>

			<Section id="Setup" title="How to set up MergeReportPost">
				<ol>
					<li>
...
export default MergeReportPost
