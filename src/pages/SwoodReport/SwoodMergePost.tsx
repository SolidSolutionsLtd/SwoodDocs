...
import { SwoodMergePostTag, SolidWorksTag, SwoodDataDirectoryTag, SwoodDesignTag, SwoodNestingTag, SwoodMergeTag } from '../../components/NameTags'
...
const SwoodMergePost = () => {
		...
		<>
			...
			<nav>
				<ul>
					...
					<li>
						<a href="#Disclaimer">SwoodMergePost disclaimer</a>
					</li>
					<li>
						<a href="#Setup">How to set up SwoodMergePost</a>
					</li>
				</ul>
			</nav>
			<Section id="Overview" title="Overview">
				...
				<Typography>
					To address this, a new <SwoodMergePostTag link={false} /> has been developed to consolidate the data from Design and Nesting projects into a single report. Please read further to understand its workflow, FAQs, and setup.
				</Typography>
			...
			<Section id="Terminology" title="Terminology">
				...
				<ListItem>
					<ListItemText
						...
						secondary={
							<>
								A report generated by <SwoodMergePostTag link={false} />
							</>
						}
					/>
				</ListItem>
			...
			<Section id="Workflow" title="Workflow">
				...
				<ol>
					...
					<li>
						<SwoodMergePostTag link={false} /> will automatically generate a merged report.
					</li>
				</ol>
				<SwoodMergePostDiagram />
			</Section>
			<Section id="FAQs" title="FAQs">
				...
				<ListItem>
					<ListItemText
						primary="Can I merge multiple Design projects without a Nest project?"
						secondary={
							<>
								This is not possible. However, this is achievable with <SwoodMergeTag />
							</>
						}
					/>
				</ListItem>
				...
				<ListItem>
					<ListItemText
						primary="Can I merge multiple Nest projects?"
						secondary={
							<>
								This is not possible. However, this is achievable with <SwoodMergeTag />
							</>
				...
				<ListItem>
					<ListItemText
						...
						secondary={
							<>
								<SwoodMergePostTag link={false} /> will only merge the available data from existing reports. As a result, some information such as hardware, frames, and unnested panels may be missing in the merged report.
							</>
						}
					/>
				</ListItem>
				...
				<ListItem>
					<ListItemText
						...
						secondary={
							<>
								<SwoodMergePostTag link={false} /> will not generate any files. You will also notice the message below when clicking on <span className="param">Documents &gt; Home Merged Report</span>.
							</>
						}
					/>
				</ListItem>
			...
			<Box className="red">
				<Section id="Disclaimer" title="SwoodMergePost disclaimer">
					<BetaDisclaimer />
				</Section>
			</Box>

			<Section id="Setup" title="How to set up SwoodMergePost">
				<ol>
					<li>
						Download <span className="highlight">SwoodMergePost.exe</span>.
					</li>
					...
					<li>
						Place <span className="highlight">SwoodMergePost.exe</span> in your <SwoodDataDirectoryTag /> in the following folder <span className="param">&lt;SWOOD DATA DIRECTORY&gt;\DAT\Documents\Report Posts</span> folder.
					</li>
					<li>
    ...
    [MERGE_REPORT]
		...
		PRIORITY = 1
		POSTPROCESS = DAT\\Documents\\Report Posts\\SwoodMergePost.exe
