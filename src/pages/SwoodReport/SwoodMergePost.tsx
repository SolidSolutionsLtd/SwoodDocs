	...
	return (
		<>
			...
			<Section id="Overview" title="Overview">
				...
				<Typography>
					To address this, a new <SwoodMergePostTag /> has been developed to consolidate the data from Design and Nesting projects into a single report. Please read further to understand its workflow, FAQs, and setup.
				</Typography>
			...
			<Section id="Terminology" title="Terminology">
				...
				<ListItem>
					<ListItemText
						...
						secondary={
							<>
								A report generated by <SwoodMergePostTag />
							</>
						}
					/>
				</ListItem>
			...
			<Section id="Workflow" title="Workflow">
				...
				<ol>
					...
					<li>
						<SwoodMergePostTag /> will automatically generate a merged report.
					</li>
				</ol>
			...
			<Section id="FAQs" title="FAQs">
				...
				<ListItem>
					<ListItemText
						...
						secondary={
							<>
								<SwoodMergePostTag /> will only merge the available data from existing reports. As a result, some information such as hardware, frames, and unnested panels may be missing in the merged report.
							</>
						}
					/>
				</ListItem>
				...
				<ListItem>
					<ListItemText
						...
						secondary={
							<>
								<SwoodMergePostTag /> will not generate any files. You will also notice the message below when clicking on <span className="param">Documents &gt; Home Merged Report</span>.
							</>
						}
					/>
				</ListItem>
